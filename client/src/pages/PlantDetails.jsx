...
function PlantDetails() {
	...
	const deletePlantNote = (id, noteId) => {
		...
		deletePlantNoteMutation({ variables: { id, noteId } });
	};
		...
		<Stack direction='row' sx={{ placeContent: 'center', padding: 5 }}>
			...
			>
				...
				<Stack direction='column' p={2}>
					...
					<span>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illum, rerum nam. Ipsam veniam asperiores cumque ullam? Dignissimos asperiores dolorum
						nisi!
					</span>
